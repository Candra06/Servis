 <head>
  ...
  <body>
      ...
      <?php
        include str_replace("system", "application/views/operator/", BASEPATH)."/layout/head.php";
        include str_replace("system", "application/views/operator/", BASEPATH)."/layout/sidebar.php"; 
      ?>
     <div class="br-mainpanel">
     

      <?php
        include str_replace("system", "application/views/operator/", BASEPATH)."/layout/content.php";
      ?>
